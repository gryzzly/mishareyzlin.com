...
In the [first part of this series](https://mishareyzlin.com/notes/prose-mirror-web-component-part-1), we have set up import maps for ProseMirror packages to enable build-less development for our web component.
